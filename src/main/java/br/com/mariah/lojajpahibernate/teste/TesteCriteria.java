...
public class TesteCriteria {
	...
	public static void main(String[] args) {
		...
		List<Produto> buscarPorParametrosComCriteria = produtoDAO.buscarPorParametrosComCriteria(null, null, LocalDate.now());
		for (Produto produto : buscarPorParametrosComCriteria) {
